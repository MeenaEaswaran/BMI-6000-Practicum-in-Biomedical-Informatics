...
setwd("~/Desktop/Practicum Fall 2025/Approach_2_case_control_integratedspace/SCENIC_LSCC")
...
scenicOptions<- readRDS("/Users/meena/Desktop/Practicum Fall 2025/Approach_2_case_control_integratedspace/SCENIC_LSCC/scenicOptions.Rds")

cellInfo <- readRDS("/Users/meena/Desktop/Practicum Fall 2025/Approach_2_case_control_integratedspace/SCENIC_LSCC/int/cellInfo.Rds")
...
ggsave("10_anotherheatmap_condition_celltype_regulon_verystrict.png", p, width = 18, height = 6, dpi = 300)
