...
dbDir <- "/Users/meena/Desktop/Practicum Fall 2025/Approach_2_case_control_integratedspace/SCENIC_LSCC/cisTarget_databases" # RcisTarget databases location
myDatasetTitle <- "SCENIC LSCC" # choose a name for your analysis
data(defaultDbNames)
...
scenicOptions@inputDatasetInfo$cellInfo <- 
  "/Users/meena/Desktop/Practicum Fall 2025/Approach_2_case_control_integratedspace/SCENIC_LSCC/cellInfo.Rds"

scenicOptions@inputDatasetInfo$colVars <- 
  "/Users/meena/Desktop/Practicum Fall 2025/Approach_2_case_control_integratedspace/SCENIC_LSCC/colVars.Rds"

#Save to use at a later time
saveRDS(scenicOptions, 
        file="/Users/meena/Desktop/Practicum Fall 2025/Approach_2_case_control_integratedspace/SCENIC_LSCC/scenicOptions.Rds") 
...
#adjusted with stricter calculations (Very strict (10%)) - used this 
genesKept <- geneFiltering(exprMat, scenicOptions = scenicOptions,
                           minCountsPerGene = 3 * .10 * ncol(exprMat),
                           minSamples = ncol(exprMat) * .10)

#We have 2878 genes after filtering with adjusted features.

#check interesting genes
interestingGenes <- c("SOX9", "SOX10", "DLX5", "SOX2", "SOX4") #human nomenclature
#what is missing?
interestingGenes[which(!interestingGenes %in% genesKept)] 
#"SOX9"  "SOX10" "DLX5"  are missing. 
...
#Only 167 (10%) of the 1605 TFs in the database were found in the dataset with very strict filtering options.
...
#Number of links between TFs and targets (weight>=0.001): 475210
#[,1]
#nTFs         167
#nTargets    2878 #genes
#nGeneSets   1218
#nLinks    877984 # possible links
